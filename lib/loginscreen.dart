...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _onLogin() {
    ...
    http.post(
        Uri.parse("https://hubbuddies.com/s269426/prgi/php/login_user.php"),
      ...
      if (response.body == "failed") {
        ...
        User user = new User(email: _email);

        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (content) => InfoScreen(user: user)));
      }
    });
  }
  ...
  void _resetPass(String resetemail) {
    http.post(
        Uri.parse("https://hubbuddies.com/s269426/prgi/php/reset_user.php"),
